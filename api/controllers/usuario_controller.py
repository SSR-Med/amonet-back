...
from Application.Features.Usuario.GetUsuarioById.query import (
    GetUsuarioByIdQuery,
...
async def get_usuario_by_id(
    ...
    handler = GetUsuarioByIdQueryHandler(session)
    return await handler.handle(GetUsuarioByIdQuery(id=id))
